...
'message error Nama belakang'
WebUI.getText(findTestObject('Page_Cermati Pinjaman, Kartu Kredit, Asuran_094e95/div_Input harus berupa huruf'), FailureHandling.STOP_ON_FAILURE)
