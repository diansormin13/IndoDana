...
'Confirm kata sandi not equal'
WebUI.getText(findTestObject('Page_Cermati Pinjaman, Kartu Kredit, Asuran_094e95/div_Kata Sandi tidak cocok'), FailureHandling.STOP_ON_FAILURE)
