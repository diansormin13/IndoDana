...
'Email'
WebUI.setText(findTestObject('Page_Cermati Pinjaman, Kartu Kredit, Asuran_094e95/input_Email_email'), ' ')
...
'Email kosong'
WebUI.getText(findTestObject('Object Repository/Page_Cermati Pinjaman, Kartu Kredit, Asuran_094e95/div_Input wajib diisi'), 
